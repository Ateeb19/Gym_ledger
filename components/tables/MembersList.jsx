...
import { deleteById, getMembers } from '../../redux/slices/membersSlice'
...
const MembersList = () => {
  ...
  const deletehandler = async(id) => {
    const confirmDel = window.confirm("Are you sure you want to delete the member");
     ...
     <div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center mb-4">
        ...
        <div className="w-full sm:max-w-max ml-auto">
          <Link href="/members/add-member"  className="px-4 py-2 text-white rounded-md hover:bg-blue-700 transition"
